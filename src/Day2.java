public class Day2 {
    ...
    public static void main(String[] args) {
        String input = "2-6 c: fcpwjqhcgtffzlbj\n" +
                "6-9 x: xxxtwlxxx\n" +
                "5-6 w: wwwwlwwwh\n" +
    ...
    public void day2(String input) {
        String[] arr = input.split("\\r?\\n");
        int p1Counter = 0;
        int p2Counter = 0;
        for (String line : arr) {
            if (part1PasswordChecker(line)) {
                p1Counter++;
            }
            if (part2PasswordChecker(line)) {
                p2Counter++;
            }
        }
        System.out.println("Part 1 correct passwords: " + p1Counter);
        System.out.println("Part 2 correct passwords: " + p2Counter);
    }


    public boolean part1PasswordChecker(String line) {
        String[] lineSplit = line.split("\\s");

        String letter = lineSplit[1].substring(0, 1);
    ...
    public boolean part2PasswordChecker(String line) {
        String[] lineSplit = line.split("\\s");

        char letter = lineSplit[1].substring(0, 1).charAt(0);
        String password = lineSplit[2];
        String[] numberSplit = lineSplit[0].split("-");
        int index1 = Integer.parseInt(numberSplit[0]) - 1;
        int index2 = Integer.parseInt(numberSplit[1]) - 1;
